...
public class Archer extends Person {
    ...
    public Archer (String name, int age, int x, int y) {
        super(name,100, 400, 400, 100, x, y, 3, true);
        this.maxHealth = 400;
    ...
    public void attack (Person person) {
        if (this.armor == 0) {
            System.out.println("У" + " " + this.name + " " + "кончились стрелы");
            return;
        } else {
            Random rdm = new Random();
            int lucky = rdm.nextInt(100);
    ...
    public String toString() {
        ...
        return String.format("[Лучник] %s", super.name + "❤\uFE0F:" + this.health + " " + "\uD83D\uDEE1\uFE0F:" + this.defence + " " + "\uD83C\uDFAF" +
                ":" + this.armor + " "  + "\uD834\uDD1C:" + position.toString());
    }
